...
vehicle_1 = Vehicle.create!(name: "Voiture volante", description: "Un véhicule qui peut se transformer en avion, offrant une solution de transport polyvalente pour éviter les embouteillages.", category: "voiture", price: 7, user_id: user_1.id)
vehicle_2 = Vehicle.create!(name: "Train à grande vitesse maglev", description: "Un train utilisant la lévitation magnétique pour atteindre des vitesses élevées, offrant un moyen rapide et confortable de voyager entre les villes.", category: "train", price: 80, user_id: user_2.id)
